        ...
        <div class="container px-4 py-5" id="custom-cards">
            ...
            <div class="row row-cols-1 row-cols-lg-3 align-items-stretch g-4 py-5">
                <div class="col shops__card-card">
                    <a href="/shops/mac" style="text-decoration: none">
                ...
                <div class="col shops__card-card">
                    <a href="/shops/pyaterochka" style="text-decoration: none">
                ...
                <div class="col shops__card-card">
                    <a href="/shops/perekrestok" style="text-decoration: none">
            ...
            <div class="row row-cols-1 row-cols-lg-3 align-items-stretch g-4 py-5">
                ...
                <div class="col shops__card-card">
                    <a href="/shops/bk" style="text-decoration: none">
                ...
                <div class="col shops__card-card">
                    <a href="/shops/kfc" style="text-decoration: none">
                ...
                <div class="col shops__card-card">
                    <a href="/shops/mag" style="text-decoration: none">
